package eab.framework.other{
	 ...
	 */
	public class EABFrameworkMessageCodes{
	   ...
	   public static const FIGURECANVAS_ALREADY_REGISTERED : String = "C0016E";
	   
	   public static const NULL_OBJECT_ERROR : String = "C0017E";
