package eab.framework.commands{
   ...
   import eab.framework.control.EABFrameworkEventDispatcher;
   ...
   public class SequenceCommand implements ICommand{      
       ...
       */
      public var nextEvent : EABFrameworkEvent;       
       
       /**
       * Constructor, with optional nextEvent.
       */
      public function SequenceCommand( nextEvent : EABFrameworkEvent = null ) : void{
      ...
      public function executeNextCommand() : void{
         ...
         if( isSequenceCommand )
            EABFrameworkEventDispatcher.getInstance().dispatchEvent( nextEvent );
      }
