package eab.framework.view{
    ...
    * </p>
    *
    * @see eab.framework.model.ModelLocator
    * @see eab.framework.view.ViewHelper
   ...
   public class ViewLocator
   {
      ...
      public function ViewLocator()
      {
         if ( ViewLocator.viewLocator != null )
         {
            throw new EABFrameworkError(
               EABFrameworkMessageCodes.SINGLETON_EXCEPTION, "ViewLocator" );
         }
      ...
      public function register( viewName : String, viewHelper : ViewHelper ) : void
      {
         ...
         {
            throw new EABFrameworkError(
               EABFrameworkMessageCodes.VIEW_ALREADY_REGISTERED, viewName );
         }
      ...
      public function unregister( viewName : String ) : void
      {
         ...
         {
            throw new EABFrameworkError(
               EABFrameworkMessageCodes.VIEW_NOT_FOUND, viewName );
         }
