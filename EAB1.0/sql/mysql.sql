-- ServiceMix Log
DROP TABLE IF EXISTS eab_service_log;
CREATE TABLE eab_service_log (
  ID varchar(63) NOT NULL,
  InvokeTime datetime DEFAULT NULL,
