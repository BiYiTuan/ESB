...
public class TInstanceSummaryInstances  implements java.io.Serializable {
    private org.apache.www.ode.pmapi.types.TInstanceStatus state;  // attribute
    ...
    public TInstanceSummaryInstances(
           org.apache.www.ode.pmapi.types.TInstanceStatus state,
           int count) {
           this.state = state;
           this.count = count;
    }
     ...
     * @return state
     */
    public org.apache.www.ode.pmapi.types.TInstanceStatus getState() {
        return state;
    }
     ...
     * @param state
     */
    public void setState(org.apache.www.ode.pmapi.types.TInstanceStatus state) {
        this.state = state;
    }
