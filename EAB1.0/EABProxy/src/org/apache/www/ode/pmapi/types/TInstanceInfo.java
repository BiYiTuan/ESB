...
public class TInstanceInfo  implements java.io.Serializable {
    ...
    private org.apache.www.ode.pmapi.types.TScopeRef rootScope;

    /* Status of ths instance. */
    private org.apache.www.ode.pmapi.types.TInstanceStatus status;
    ...
    private org.apache.www.ode.pmapi.types.TCorrelationProperty[] correlationProperties;

    /* Information about the events for this instance. If
     *                         absent, indicates events are not available. */
    private org.apache.www.ode.pmapi.types.TInstanceInfoEventInfo eventInfo;

    /* If present, indicates the fault with which this
     *                         instance failed. */
    private org.apache.www.ode.pmapi.types.TFaultInfo faultInfo;

    private org.apache.www.ode.pmapi.types.TFailuresInfo failures;
    ...
    public TInstanceInfo(
           ...
           org.apache.www.ode.pmapi.types.TScopeRef rootScope,
           org.apache.www.ode.pmapi.types.TInstanceStatus status,
           java.util.Calendar dtStarted,
           java.util.Calendar dtLastActive,
           java.util.Calendar dtErrorSince,
           org.apache.www.ode.pmapi.types.TCorrelationProperty[] correlationProperties,
           org.apache.www.ode.pmapi.types.TInstanceInfoEventInfo eventInfo,
           org.apache.www.ode.pmapi.types.TFaultInfo faultInfo,
           org.apache.www.ode.pmapi.types.TFailuresInfo failures) {
           this.iid = iid;
           this.pid = pid;
     ...
     */
    public org.apache.www.ode.pmapi.types.TScopeRef getRootScope() {
        return rootScope;
    }
     ...
     */
    public void setRootScope(org.apache.www.ode.pmapi.types.TScopeRef rootScope) {
        this.rootScope = rootScope;
    }
     ...
     */
    public org.apache.www.ode.pmapi.types.TInstanceStatus getStatus() {
        return status;
    }
     ...
     */
    public void setStatus(org.apache.www.ode.pmapi.types.TInstanceStatus status) {
        this.status = status;
    }
     ...
     *                         are associated with this process instance.
     */
    public org.apache.www.ode.pmapi.types.TCorrelationProperty[] getCorrelationProperties() {
     ...
     *                         are associated with this process instance.
     */
    public void setCorrelationProperties(org.apache.www.ode.pmapi.types.TCorrelationProperty[] correlationProperties) {
        this.correlationProperties = correlationProperties;
    }
     ...
     *                         absent, indicates events are not available.
     */
    public org.apache.www.ode.pmapi.types.TInstanceInfoEventInfo getEventInfo() {
        return eventInfo;
    }
     ...
     *                         absent, indicates events are not available.
     */
    public void setEventInfo(org.apache.www.ode.pmapi.types.TInstanceInfoEventInfo eventInfo) {
        this.eventInfo = eventInfo;
    }
     ...
     *                         instance failed.
     */
    public org.apache.www.ode.pmapi.types.TFaultInfo getFaultInfo() {
        return faultInfo;
    }
     ...
     *                         instance failed.
     */
    public void setFaultInfo(org.apache.www.ode.pmapi.types.TFaultInfo faultInfo) {
        this.faultInfo = faultInfo;
    }
     ...
     * @return failures
     */
    public org.apache.www.ode.pmapi.types.TFailuresInfo getFailures() {
        return failures;
    }
     ...
     * @param failures
     */
    public void setFailures(org.apache.www.ode.pmapi.types.TFailuresInfo failures) {
        this.failures = failures;
    }
