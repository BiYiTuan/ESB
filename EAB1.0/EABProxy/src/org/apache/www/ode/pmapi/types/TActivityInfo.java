...
public class TActivityInfo  implements java.io.Serializable {
    ...
    private org.apache.www.ode.pmapi.types.TActivityStatus status;

    /* ID for scope in which this activity is executing. */
    private org.apache.www.ode.pmapi.types.TScopeRef scope;
    ...
    private org.apache.www.ode.pmapi.types.TFailureInfo failure;
    ...
    public TActivityInfo(
           ...
           org.apache.www.ode.pmapi.types.TActivityStatus status,
           org.apache.www.ode.pmapi.types.TScopeRef scope,
           java.util.Calendar dtEnabled,
           java.util.Calendar dtStarted,
           java.util.Calendar dtCompleted,
           org.apache.www.ode.pmapi.types.TFailureInfo failure) {
           this.name = name;
           this.type = type;
           this.aiid = aiid;
           this.status = status;
     ...
     * @return status
     */
    public org.apache.www.ode.pmapi.types.TActivityStatus getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(org.apache.www.ode.pmapi.types.TActivityStatus status) {
        this.status = status;
    }
     ...
     */
    public org.apache.www.ode.pmapi.types.TScopeRef getScope() {
        return scope;
    }
     ...
     */
    public void setScope(org.apache.www.ode.pmapi.types.TScopeRef scope) {
        this.scope = scope;
    }
     ...
     */
    public org.apache.www.ode.pmapi.types.TFailureInfo getFailure() {
        return failure;
    }
     ...
     */
    public void setFailure(org.apache.www.ode.pmapi.types.TFailureInfo failure) {
        this.failure = failure;
    }
