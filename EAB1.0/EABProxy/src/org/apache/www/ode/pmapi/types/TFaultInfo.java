...
public class TFaultInfo  implements java.io.Serializable {
    ...
    private org.apache.www.ode.pmapi.types.TFaultInfoData data;
    ...
    public TFaultInfo(
           ...
           int lineNumber,
           int aiid,
           org.apache.www.ode.pmapi.types.TFaultInfoData data) {
           this.name = name;
     ...
     * @return data
     */
    public org.apache.www.ode.pmapi.types.TFaultInfoData getData() {
        return data;
    }
     ...
     * @param data
     */
    public void setData(org.apache.www.ode.pmapi.types.TFaultInfoData data) {
        this.data = data;
    }
