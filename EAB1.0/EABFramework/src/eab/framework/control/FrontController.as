package eab.framework.control{   	
   ...
   import eab.framework.commands.ICommand;
    ...
    *
    * <pre>
    * class LoginController extends eab.framework.control.FrontController
    * {
    ...
    * </pre>
    *
    * @see eab.framework.commands.ICommand
    */
   ...
   public class FrontController{
      ...
      */     
      public function addCommand( commandName : String, commandRef : Class, useWeakReference : Boolean = true ) : void{
         ...
         if( commands[ commandName ] != null )
            throw new EABFrameworkError( EABFrameworkMessageCodes.COMMAND_ALREADY_REGISTERED, commandName );
         
         commands[ commandName ] = commandRef;
         EABFrameworkEventDispatcher.getInstance().addEventListener( commandName, executeCommand, false, 0, useWeakReference );
      }
      ...
      */     
      public function removeCommand( commandName : String ) : void{
         ...
         if( commands[ commandName ] === null)
            throw new EABFrameworkError( EABFrameworkMessageCodes.COMMAND_NOT_REGISTERED, commandName);  
         
         EABFrameworkEventDispatcher.getInstance().removeEventListener( commandName, executeCommand );
      ...
      */  
      protected function executeCommand( event : EABFrameworkEvent ) : void{
      ...
      */
      protected function getCommand( commandName : String ) : Class{
         ...
         if ( command == null )
            throw new EABFrameworkError( EABFrameworkMessageCodes.COMMAND_NOT_FOUND, commandName );
