package eab.framework.business{
   ...
   {   
      ...
      {   
         if ( instance != null )
         {
            throw new EABFrameworkError( EABFrameworkMessageCodes.SINGLETON_EXCEPTION, "ServiceLocator" );
         }
      ...
      private function getServiceForId( serviceId : String ) : Object
      {
         ...
         {
            throw new EABFrameworkError( EABFrameworkMessageCodes.SERVICE_NOT_FOUND, serviceId );
         }
