package eab.framework.business{
   ...
   public class AbstractServices implements IServices
   {
      ...
      {
         throw new EABFrameworkError( EABFrameworkMessageCodes.ABSTRACT_METHOD_CALLED, "register" );
      }
      ...
      {
         throw new EABFrameworkError( EABFrameworkMessageCodes.ABSTRACT_METHOD_CALLED, "getService" );
      }
      ...
      {
         throw new EABFrameworkError( EABFrameworkMessageCodes.ABSTRACT_METHOD_CALLED, "setCredentials" );
      }
      ...
      {
         throw new EABFrameworkError( EABFrameworkMessageCodes.ABSTRACT_METHOD_CALLED, "setRemoteCredentials" );
      }
      ...
      {
         throw new EABFrameworkError( EABFrameworkMessageCodes.ABSTRACT_METHOD_CALLED, "logout" );
      }
