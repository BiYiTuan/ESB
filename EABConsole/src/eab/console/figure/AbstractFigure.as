...
{
	import eab.console.vo.BasicAttribute;
	import eab.console.vo.IAttribute;
...
//		var symbolheight:Number;
		...
		public var attribute:IAttribute;
...
//			this.symbolheight=Number(info.@symbolheight);
		...
		protected var _stateToken:String;	
		
		public function setStateToken(token:String):void{
			_stateToken = token;
		}
		...
		protected var _inToken:String;	
		
		public function setInToken(token:String):void{
			_inToken = token;
		}
		
		public function getInToken():String{
			return _inToken;
		}
		
		protected var _outToken:String;
		
		public function setOutToken(token:String):void{
			_outToken = token;
		}
		
		public function getOutToken():String{
			return _outToken;
		}
		
		protected var _parameters:ArrayCollection;
		
		public function setParameters(dict:ArrayCollection):void{
			_parameters = dict;
		}
		...
		public function getParameter(para:String):String{
			if(_parameters == null)
				return null; 
				
			for(var i:int = 0; i < _parameters.length;i++){
				if(_parameters[i].key == para)
