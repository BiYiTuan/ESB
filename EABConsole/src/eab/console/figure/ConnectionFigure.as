package eab.console.figure
{
	...
	import eab.console.events.LabelLinkEvent;
	import eab.console.figure.arrow.ArrowFactory;
	import eab.console.figure.arrow.IArrow;
	import eab.console.figure.router.IRouter;
	import eab.console.figure.router.RouterFactory;
	import eab.console.view.LinkContextPanel;
