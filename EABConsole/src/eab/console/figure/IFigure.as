...
*/
	...
	public interface IFigure
	{
		...
		function setStateToken(token:String):void;
		
		function getStateToken():String;
		
		function setInToken(token:String):void;
		
		function getInToken():String;
		
		function setOutToken(token:String):void;
		
		function getOutToken():String;

		function setParameters(dict:ArrayCollection):void;
